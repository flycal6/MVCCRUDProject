...
public class LostTeamController {
	...
	public ModelAndView updateTeam(String name, String firstYear, String lastYear, String relocatedTo,
			String seasons, String record, String winPercent, String playoffs, String stanleyCups,
			String reason, String logo, HttpSession session) {
		ModelAndView mv = new ModelAndView();
