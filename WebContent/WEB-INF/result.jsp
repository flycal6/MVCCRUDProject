	...
	<nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="addTeam.do">Add Team</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="EditTeam.do">Edit Team</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="RemoveTeam.do">Delete This Team</a>
          </li>
        ...
        <form class="form-inline my-2 my-lg-0 findTeam" action="GetTeamByName.do" method="POST">
          <input class="form-control mr-sm-2" type="text" name="teamName" placeholder="Find Team" aria-label="Find Team">
